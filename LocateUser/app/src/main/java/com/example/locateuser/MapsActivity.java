package com.example.locateuser;
...
import com.example.locateuser.databinding.ActivityMapsBinding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location location) {
                ...
                mMap.clear();//clear older location marker in google map
                mMap.addMarker(new MarkerOptions().position(userLatLong).title("your location israa"));
        ...
        //ask for map permission with user / location permission
